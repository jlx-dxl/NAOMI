...
saveDir              = '../results/test_1/';                                      % Pick a directory name to save to
saveName             = 'TPM_volume.mat';                                   % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
write_TPM_movie(Fsim, [saveDir, saveName]);                                % Saves Fsim to save_name which can be a .mat, .tif or .fits file
