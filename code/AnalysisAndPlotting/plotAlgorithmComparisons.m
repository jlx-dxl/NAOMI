...
cutoff     = 0.5;                                                           % This parameter controls the cutoff for identifying matches
useCnmfDff = true;
powerLevel = 1;
somaOnly   = true;
...
%     load('/jukebox/pillow/adam/naomi_sim/results/20180730_fullAlgoWorkspace.mat')
elseif powerLevel == 2
    load('/jukebox/pillow/adam/naomi_sim/results/20180802_fullAlgoWorkspace_x4.mat');
end
if somaOnly
    load('/jukebox/pillow/adam/naomi_sim/results/movie_standard_standard_long.mat','PSF_struct');
    load('/jukebox/pillow/adam/naomi_sim/results/20180504_largeVolume.mat','vol_out');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Make sure there is an ideals struct and a specified cutoff parameter

if ~exist('ideals','var'); ideals = struct(); end 
if useCnmfDff; cnmf.compTimecourse = cnmf.compDeltaFF; end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Isolate all the somatic componentes "close" to the imaging plane

if somaOnly
    idSomas = isolateVisibleSomas(vol_out,PSF_struct,vol_params,neur_params);
    est     = constrainEstToSomas(est,idSomas);
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Get correlations for all the component traces

[cnmf, pcaica, suite2p, est] = correlateAllSegmentations(cnmf, pcaica, suite2p, est, neur_act2, idSomas);
