...
save_filename        = 'misalignedOptics';                                 % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
psf_params           = getDefaultPSFParams('misaligned');                  % Get default misaligned optics imaging parameters
