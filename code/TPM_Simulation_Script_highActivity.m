...
save_path            = '../results/150Hz/';          % Set the directory to save results to
save_filename        = 'highActivityVolume';                               % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
vol_params.vol_sz    = [250,250,50];                                      % Volume size to sample (in microns)
...
spike_opts.nt        = 4500;                                              % Set number of time step
spike_opts.dt        = 1/150;                                               % Sampling frame-rate period (1/Hz)
