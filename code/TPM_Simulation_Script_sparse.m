...
save_path            = '../results/test/';          % Set the directory to save results to
save_filename        = 'sparseLabelingVolume30';                             % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
vol_params.vol_sz    = [20,20,100];                                       % Volume size to sample (in microns)
...
spike_opts.nt        = 150;                                                % Set number of time step
