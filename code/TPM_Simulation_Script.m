...
saveDir              = 'F:\Laboratory\NAOMI\320Hz_500pixels_1\';              % Pick a directory name to save to
saveName             = '320Hz_clean.tif';                                  % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
saveName1             = '320Hz_noisy1.tif';                                 % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
saveName2             = '320Hz_noisy2.tif';                                 % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
saveName3             = '320Hz_noisy3.tif';                                 % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
saveName4             = '320Hz_noisy4.tif';                                 % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
spike_opts.nt        = 1600;                                               % Set number of time step
...
spike_opts.rate   = 0.5;                                                  % The average rate of firing for all the components can be modulated using this parameter
spike_opts.p_off    = 0.7;                                                % 60% of the neurons do not express the indicator    
