...
save_filename        = 'lowActivityVolume';                                % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
spike_opts.rate      = 0.15;                                               % The average rate of firing for all the components can be modulated using this parameter
